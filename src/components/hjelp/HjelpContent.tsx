...
import InfoListItem from "./HjelpListItem";

const hjelpListItemContents = [
  {
    ...
    content: (
      <>
        <BodyLong className="mb-4">
          ...
          derfor ta en prat med den sykmeldte arbeidstakeren og diskutere
          spørsmålene i oppfølgingsplanen.
        </BodyLong>
        <BodyLong>
          Bruk{" "}
          <Link
...
export default function HjelpContent() {
  return (
    <section className="mt-8">
      {hjelpListItemContents.map((item, index) => (
        <InfoListItem
          key={index}
