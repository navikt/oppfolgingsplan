...
export const erOppfolgingsdialogOpprettbarMedArbeidsgiver = (oppfolgingsdialoger, arbeidsgiver) => {
  return (
    ...
    !erAktivOppfolgingsdialogOpprettetMedArbeidsgiver(oppfolgingsdialoger, arbeidsgiver.virksomhetsnummer)
  );
};
...
export const erSykmeldtUtenOppfolgingsdialogerOgNaermesteLedere = (
  ...
  return (
    ...
    finnArbeidsgivereForGyldigeSykmeldinger(sykmeldinger, naermesteLedere).filter((arbeidsgiver) => {
...
export const finnGodkjentedialogerAvbruttAvMotpartSidenSistInnlogging = (oppfolgingsplaner) => {
