...
export const MILLIES_MELLOM_VIS_BOKS_OG_TIMEOUT =
  VIS_TIMEOUTBOKS_MINUTTER_FOER_UTLOGGING * 60 * 1000;
...
const erBrukerSnartUtlogget = (state) => {
  return (
    state.erInnloggetTil.getTime() -
      new Date().getTime() -
      MILLIES_MELLOM_VIS_BOKS_OG_TIMEOUT <
    0
  );
};
