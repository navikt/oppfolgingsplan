...
export class KommentarListeElement extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      nextProps.kommentarReducer.slettingFeilet !==
        this.props.kommentarReducer.slettingFeilet
    ) {
  ...
  render() {
    ...
    const aktoerHarOpprettetElement =
      fnr === (kommentar.opprettetAv && kommentar.opprettetAv.fnr);
    return (
      <Snakkeboble
      ...
      >
        <div className={aktoerHarOpprettetElement ? 'blokk--s' : null}>
          {kommentar.tekst}
        </div>
        ...
        {this.state.visSlettingKommentarFeilet && feilMelding && (
          <TiltakVarselFeil tekst={texts.saveError} />
        )}
      </Snakkeboble>
    );
  }
