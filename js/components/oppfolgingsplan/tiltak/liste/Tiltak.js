...
class Tiltak extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      this.props.element.tiltakId === nextProps.tiltakReducer.feiletTiltakId
    ) {
      if (
        ...
        >
          ...
          {this.state.visLagreSkjema && (
            <TiltakSkjema
              ...
              oppdateringFeilet={
                (this.state.visLagringFeilet || this.state.visSlettingFeilet) &&
                feilMelding
              }
              varselTekst={this.state.varselTekst}
              visFeilMelding={visFeilMelding}
...
const TiltakContainer = connect(mapStateToProps, null, null, { pure: false })(
  Tiltak
);
