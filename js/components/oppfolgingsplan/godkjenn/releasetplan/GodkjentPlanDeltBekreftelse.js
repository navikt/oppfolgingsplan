  ...
  return (
    <React.Fragment>
      {oppfolgingsplan.godkjentPlan.deltMedNAV &&
        oppfolgingsplan.godkjentPlan.deltMedNAVTidspunkt && (
          <BildeTekstLinje
            imgUrl={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/nav-logo.svg`}
            imgAlt=""
            tekst={textSharedWithNAV(
              toDateMedMaanedNavn(
                oppfolgingsplan.godkjentPlan.deltMedNAVTidspunkt
              )
            )}
      ...
      {oppfolgingsplan.godkjentPlan.deltMedFastlege &&
        oppfolgingsplan.godkjentPlan.deltMedFastlegeTidspunkt && (
          <BildeTekstLinje
            imgUrl={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/medical-box.svg`}
            imgAlt=""
            tekst={textSharedWitFastlege(
              toDateMedMaanedNavn(
                oppfolgingsplan.godkjentPlan.deltMedFastlegeTidspunkt
              )
            )}
