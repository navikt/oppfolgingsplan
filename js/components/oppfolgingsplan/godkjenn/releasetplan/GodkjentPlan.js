...
const texts = {
  ...
  tvungenGodkjenning: {
    info:
      'Planen er laget av arbeidsgiveren din. Er du uenig i innholdet, må du snakke med',
  },
};
...
export const TextForcedApprovedOppfolgingsplan = ({
  rootUrl,
  oppfolgingsplan,
}) => {
  return (
        ...
        >
          <div className="godkjentPlan">
            {this.state.visBekreftelse && (
              <Lightbox onClose={this.lukkBekreftelse}>
                <AvbrytPlanBekreftelse
