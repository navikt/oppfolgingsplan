...
class GodkjentPlan extends Component {
    ...
    render() {
        ...
        const infoboksTittelNokkel = 'oppfolgingsdialog.arbeidstaker.godkjennplan.godkjent.infoboks.tittel';
        const infoboksTekst = getLedetekst('oppfolgingsdialog.arbeidstaker.godkjennplan.godkjent.infoboks.tekst', {
