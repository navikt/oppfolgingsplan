...
class Arbeidsoppgaver extends Component {
  constructor(props) {
    ...
    this.toggleArbeidsoppgaveSkjema = this.toggleArbeidsoppgaveSkjema.bind(
      this
    );
  ...
  render() {
    ...
    const antallIkkeVurdererteArbOppgaver = oppfolgingsdialog.arbeidsoppgaveListe.filter(
      (arbeidsoppgave) => {
