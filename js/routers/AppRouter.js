...
const AppRouter = ({ history }) => {
  return (
    <Router history={history}>
      <Route
        path="/oppfolgingsplan/oppfolgingsplaner"
        component={OppfolgingsdialogerSide}
      />
      <Route
        path="/oppfolgingsplan/oppfolgingsplaner/:oppfolgingsdialogId"
        component={OppfolgingsdialogSide}
      />
    </Router>
  );
};
