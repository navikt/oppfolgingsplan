  ...
  return Object.assign(
    {},
    {
      ...
      innsendtArbeidsgivernavn:
        'ARBEIDS- OG VELFERDSDIREKTORATET, AVD SANNERGATA',
...
describe('dineSykmeldingerReducer', () => {
  ...
  it('håndterer SET_DINE_SYKMELDINGER når man har sykmeldinger fra før, ved å kun overskrive properties som finnes', () => {
    const initialState = deepFreeze({
      hentet: false,
      data: [
        getParsetSykmelding({ id: '55' }),
        getParsetSykmelding({ id: '44' }),
      ],
    });
    const action = actions.setDineSykmeldinger([
    ...
    expect(nextState).to.deep.equal({
      data: [
        getParsetSykmelding({ id: '55', navn: 'Harald' }),
        getParsetSykmelding({ id: '44' }),
      ],
      henter: false,
      hentingFeilet: false,
