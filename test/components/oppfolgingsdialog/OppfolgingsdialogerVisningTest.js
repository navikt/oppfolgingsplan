...
import OppfolgingsdialogerVisning, {
  OppfolgingsdialogNyKnapp,
} from '../../../js/components/oppfolgingsdialoger/OppfolgingsdialogerVisning';
...
import { hentOppfolgingsdialogAktiv, hentOppfolgingsdialogTidligere } from '../../mock/mockOppfolgingsdialoger';
import { hentSykmeldingGyldigForOppfoelging } from '../../mock/mockSykmeldinger';
...
describe('Oppfolgingsdialoger', () => {
  ...
  it('Skal vise OppfolgingsdialogerOpprett, om visOppfolgingsdialogOpprett=true', () => {
    const komponentVisOppfolgingsdialogOpprett = shallow(
      <OppfolgingsdialogerVisning
        oppfolgingsdialoger={[]}
    ...
    describe('Har Aktiv Oppfolgingsdialog', () => {
      it('Skal vise OppfolgingsdialogNyKnapp, om AT har sykmelding som er gyldig for oppfoelging med mer enn 1 AG', () => {
        ...
        const naermesteLederListe = {
          data: [{ orgnummer: sykmeldingListe[0].orgnummer }, { orgnummer: sykmeldingListe[1].orgnummer }],
        };
        komponent = shallow(
          <OppfolgingsdialogerVisning
            oppfolgingsdialoger={[
  ...
  describe('OppfolgingsdialogNyKnapp', () => {
    ...
    it('Skal vise en knapp som kaller til OpprettOppfolgingsdialog', () => {
      komponent = shallow(<OppfolgingsdialogNyKnapp visOppfolgingsdialogOpprett={visOppfolgingsdialogOpprett} />);
