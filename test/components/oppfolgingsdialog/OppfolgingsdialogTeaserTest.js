...
} from '../../../js/components/oppfolgingsdialoger/OppfolgingsdialogTeaser';
...
describe('OppfolgingsdialogTeasere', () => {
  ...
  beforeEach(() => {
    ...
    komponent = shallow(
      <OppfolgingsdialogTeaser oppfolgingsdialog={oppfolgingsdialog} />
    );
  });
  ...
  const tilGodkjenningStatus = shallow(
