...
describe('OppfolgingsdialogTidligereUtenSykmelding', () => {
  ...
  it('Viser en span', () => {
    expect(komponent.find('span.oppfolgingsplanInnhold__ikon')).to.have.length(
      1
    );
  });
  ...
  it('Viser en span', () => {
    ...
    expect(komponent.find('span.inngangspanel__tittel').text()).to.equal(
      oppfolgingslan.virksomhet.navn
    );
  });
});
