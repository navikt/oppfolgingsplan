...
describe('ArbeidsgiverSkjema', () => {
  ...
  describe('VelgArbeidsgiverUndertekst', () => {
    it('Skal vise ikke vise en feilmelding', () => {
      ...
      expect(komponent.find('div.velgArbeidsgiverUndertekst')).to.have.length(
        0
      );
    });
    ...
    it('Skal vise en feilmelding, om det allerede er opprettet en plan med arbeidsgiver', () => {
      ...
      expect(
        komponent.find('div.velgArbeidsgiverUndertekst__lenke')
      ).to.have.length(1);
    ...
    it('Skal vise en feilmelding, om naermeste leder ikke er innmeldt', () => {
      ...
      expect(
        komponent.find('img.velgArbeidsgiverUndertekst__ikon')
      ).to.have.length(1);
      expect(
        komponent.find('span.velgArbeidsgiverUndertekst__tekst')
      ).to.have.length(1);
    });
