...
describe('ArbeidsgiverSkjema', () => {
  ...
  beforeEach(() => {
    ...
    komponent = shallow(
      <ArbeidsgiverSkjema arbeidsgivere={[]} oppfolgingsdialoger={[]} handleSubmit={handleSubmit} avbrytHref="" />
    );
  });
  ...
  describe('VelgArbeidsgiverUndertekst', () => {
    it('Skal vise ikke vise en feilmelding', () => {
      komponent = shallow(
        <VelgArbeidsgiverUndertekst oppfolgingsdialoger={oppfolgingsdialoger} arbeidsgiver={arbeidsgivere[0]} />
      );
    ...
    it('Skal vise en feilmelding, om det allerede er opprettet en plan med arbeidsgiver', () => {
      ...
      komponent = shallow(
        <VelgArbeidsgiverUndertekst oppfolgingsdialoger={oppfolgingsdialogListe} arbeidsgiver={arbeidsgivere[1]} />
      );
    ...
    it('Skal vise en feilmelding, om naermeste leder ikke er innmeldt', () => {
      komponent = shallow(
        <VelgArbeidsgiverUndertekst oppfolgingsdialoger={oppfolgingsdialoger} arbeidsgiver={arbeidsgivere[2]} />
      );
    ...
    it('Skal vise en melding med naermesteLeders navn, om naermeste leder er innmeldt', () => {
      komponent = shallow(
        <VelgArbeidsgiverUndertekst oppfolgingsdialoger={oppfolgingsdialoger} arbeidsgiver={arbeidsgivere[3]} />
      );
      expect(komponent.find('div.velgArbeidsgiverUndertekst')).to.have.length(1);
