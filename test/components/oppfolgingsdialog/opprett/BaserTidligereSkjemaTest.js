...
import { BaserTidligereSkjemaComponent } from '../../../../js/components/oppfolgingsdialoger/opprett/BaserTidligereSkjema';
...
describe('BaserTidligereSkjema', () => {
  ...
  beforeEach(() => {
    ...
    komponent = shallow(<BaserTidligereSkjemaComponent onSubmit={handleSubmit} />);
  });
