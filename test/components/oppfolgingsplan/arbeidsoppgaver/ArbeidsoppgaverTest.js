...
describe('Arbeidsoppgaver', () => {
  ...
  describe('Oppfolgingsdialog uten Arbeidsoppgaver', () => {
    ...
    beforeEach(() => {
      oppfolgingsdialogUtenArbeidsoppgaver = Object.assign(
        {},
        oppfolgingsdialog,
        {
          arbeidstaker,
    ...
    it('Skal vise ArbeidsoppgaverInfoboksStilling', () => {
      ...
      expect(
        componentUtenArbeidsoppgaver.find(ArbeidsoppgaverInfoboksStilling)
      ).to.have.length(1);
    });

    it('Skal vise OppfolgingsplanInfoboks, om det ikke er arbeidsoppgaver', () => {
      expect(
        componentUtenArbeidsoppgaver.find(OppfolgingsplanInfoboks)
      ).to.have.length(1);
    });

    it('Skal vise LeggTilElementKnapper, om det ikke er arbeidsoppgaver', () => {
      expect(
        componentUtenArbeidsoppgaver.find(LeggTilElementKnapper)
      ).to.have.length(1);
    });
    ...
    it('Skal vise LagreArbeidsoppgaveSkjema, om det ikke er arbeidsoppgaver og visArbeidsoppgaveSkjema er true', () => {
      ...
      expect(
        componentUtenArbeidsoppgaver.find(LagreArbeidsoppgaveSkjema)
      ).to.have.length(1);
    });
    ...
    it('Skal ikke vise feilmelding dersom lagring av ny arbeidsoppgave ikke feilet', () => {
      ...
      component.setProps({
        arbeidsoppgaver: { lagringFeilet: true, feiletOppgaveId: 5 },
      });
      expect(component.state().varselTekst).to.equal('');
    });
  });
  ...
  describe('Oppfolgingsdialog med Arbeidsoppgaver', () => {
    ...
    beforeEach(() => {
      oppfolgingsdialogMedArbeidsoppgaver = Object.assign(
        {},
        oppfolgingsdialog,
        {
          arbeidstaker,
    ...
    it('Skal vise ArbeidsoppgaverInfoboksStilling', () => {
      expect(
        componentMedArbeidsoppgaver.find(ArbeidsoppgaverInfoboksStilling)
      ).to.have.length(1);
    });

    it('Skal vise NotifikasjonBoksVurderingOppgave, om nye Arbeidsoppgaver er lagt til av motpart', () => {
      const oppfolgingsdialogMedNyeArbeidsoppgaver = Object.assign(
        {},
        oppfolgingsdialog,
        {
          arbeidstaker,
      ...
      const componentMedNyeArbeidsoppgaver = shallow(
        <Arbeidsoppgaver
          arbeidsoppgaver={arbeidsoppgaver}
      ...
      expect(
        componentMedNyeArbeidsoppgaver.find(NotifikasjonBoksVurderingOppgave)
      ).to.have.length(1);
    });

    it('Skal vise ArbeidsoppgaverListe, om det er arbeidsoppgaver', () => {
      expect(
        componentMedArbeidsoppgaver.find(ArbeidsoppgaverListe)
      ).to.have.length(1);
    });
    ...
    it('Skal vise LagreArbeidsoppgaveSkjema, om det er arbeidsoppgaver og visArbeidsoppgaveSkjema er true', () => {
      ...
      expect(
        componentMedArbeidsoppgaver.find(LagreArbeidsoppgaveSkjema)
      ).to.have.length(1);
    });
  });
});
