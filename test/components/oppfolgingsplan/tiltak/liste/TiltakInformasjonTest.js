...
describe('TiltakInformasjon', () => {
  ...
  beforeEach(() => {
    ...
    komponent = shallow(
      <TiltakInformasjon element={oppfolgingsdialog.tiltakListe[0]} kommentarReducer={kommentar} lagreKommentarSkjema />
    );
  });
  ...
  it('Skal vise TabellTiltakBeskrivelseIkkeAktuelt', () => {
    ...
    komponent = shallow(<TiltakInformasjon element={tiltak} kommentarReducer={kommentar} />);
