...
describe('GodkjentPlan', () => {
  ...
  it('Skal vise en GodkjentPlanDeltBekreftelse', () => {
    expect(komponentDefault.find(GodkjentPlanDeltBekreftelse)).to.have.length(
      1
    );
  });
  ...
  it('Skal vise en GodkjentPlanHandlingKnapper', () => {
    expect(komponentDefault.find(GodkjentPlanHandlingKnapper)).to.have.length(
      1
    );
  });
  ...
  describe('Tvungen Godkjenning', () => {
    ...
    const k3 = shallow(<GodkjentPlanEkspanderbar dokument={dokument} />);
