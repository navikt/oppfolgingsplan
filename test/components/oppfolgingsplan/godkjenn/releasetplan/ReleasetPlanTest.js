...
describe('ReleasetPlan', () => {
  ...
  it('Skal vise Samtykke når det savnes', () => {
    komponent = shallow(
      <ReleasetPlan
  ...
  it('Skal vise TidligereAvbruttePlaner', () => {
    komponent = shallow(
      <ReleasetPlan oppfolgingsdialog={oppfolgingsdialogMedSamtykke} />
    );
  ...
  it('Skal vise en GodkjentPlanAvbrutt med samtykke og avbruttplan', () => {
    komponent = shallow(
      <ReleasetPlan
        oppfolgingsdialog={oppfolgingsdialogMedSamtykkeOgAvbruttplan}
