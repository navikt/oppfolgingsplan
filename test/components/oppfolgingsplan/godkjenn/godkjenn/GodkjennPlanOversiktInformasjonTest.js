...
describe('GodkjennPlanOversiktInformasjon', () => {
  ...
  it('Skal vise en GodkjennPlanOversiktInformasjon', () => {
    expect(
      komponentDefault.find('div.godkjennPlanOversiktInformasjon')
    ).to.have.length(1);
  });
  ...
  it('Skal vise et InformasjonPanelArbeidsgiver', () => {
    expect(komponentDefault.find(InformasjonPanelArbeidsgiver)).to.have.length(
      1
    );
  });
  ...
  it('Skal vise et InformasjonPanelArbeidsoppgaver', () => {
    expect(
      komponentDefault.find(InformasjonPanelArbeidsoppgaver)
    ).to.have.length(1);
  });
  ...
  describe('InformasjonPanelOverskrift', () => {
    ...
    it('Skal vise en InformasjonPanelOverskrift', () => {
      expect(
        komponent.find('div.godkjennPlanOversiktInformasjon__panel')
      ).to.have.length(1);
    });
  ...
  describe('InformasjonPanelSykmeldt', () => {
    ...
    it('Skal vise Felter med informasjon', () => {
      expect(
        komponent.find('dl.godkjennPlanOversiktInformasjon__panel__info')
      ).to.have.length(1);
  ...
  describe('InformasjonPanelArbeidsoppgaverEtterGjennomfoering', () => {
    ...
    it('Skal vise en tittel', () => {
      expect(
        komponent.find(
          'div.godkjennPlanOversiktInformasjon__panel__gjennomfoering'
        )
      ).to.have.length(1);
    });
    ...
    it('Skal vise en div med informasjon per Arbeidsoppgave', () => {
      expect(
        komponent.find(
          'div.godkjennPlanOversiktInformasjon__panel__arbeidsoppgave'
        )
      ).to.have.length(arbeidsoppgaveListe.length);
    });
  });
  ...
  describe('InformasjonPanelTiltak', () => {
    ...
    const komponent = shallow(
      <InformasjonPanelTiltak tiltakListe={tiltakListe} />
    );

    it('Skal vise en div med informasjon per Tiltak', () => {
      expect(
        komponent.find('div.godkjennPlanOversiktInfo__panel__tiltak')
      ).to.have.length(tiltakListe.length);
    });
  });
});
